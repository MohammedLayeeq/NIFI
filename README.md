...
https://community.hortonworks.com/articles/55422/change-dat
https://www.linkedin.com/pulse/olympics-dataset-streaming-hive-using-nifi-ned-shawa
https://github.com/chenjr0719/NiFi-Examples

https://drive.google.com/file/d/1FkfeAeVODt3UQbLmSSUg26SJVlNtrVdx/view?usp=sharing
...
select Max(snum)from salespeople where snum <(select Max(snum) from salespeople where snum <(select Max(snum) from salespeople));
